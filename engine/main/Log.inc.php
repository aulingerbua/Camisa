...
define ( "LOG_WARN", "warning" ); // !< string for the log level "warning"
 ...
 *
 * A log file consists of JSON Objects separated by double-semicolons. The firs JSON object contains the log header.
