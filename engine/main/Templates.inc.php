...
class Templates extends Registry {
	...
	public function showForm($iniValues = NULL) {
		...
		$form [] = '<h3>Neues Template registrieren</h3>';
		$form [] = '<div class="box-inside-form">';
		$form [] = '<div>';
		$form [] = '<label for="template">Template Name</label>';
		$form [] = self::templatesDropdown ( PagesPath, "tpl", "template" );
		$form [] = '<label for="module">Template Modul</label>';
