...
abstract class Registry {
	...
	/**
	 * Get the values of the submit, update, delete and reset buttons.
	 *
	 * @param array ...$names
	 *        	which
	 *        	names to recieve.
	 ...
	 * @return array an associated array with the results of the data base query
	 */
